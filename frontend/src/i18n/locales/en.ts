  ...
  admin: {
    ...
    ops: {
      ...
      diagnosis: {
        ...
        notifyQueueStatusUnavailable: 'Ops notify queue status unavailable',
        notifyQueueStatusUnavailableImpact: 'Cannot assess notification delivery health',
        notifyQueueStatusUnavailableAction: 'Check Redis connectivity and stream keys',
        notifyQueueDlqCritical: 'Ops notify DLQ has {count} message(s)',
        notifyQueueDlqCriticalImpact: 'Ops alerts/reports may not be delivered',
        notifyQueueDlqCriticalAction: 'Inspect DLQ entries, fix webhook platform configuration, then retry delivery',
        notifyQueueNoConsumers: 'Ops notify queue has no active consumers',
        notifyQueueNoConsumersImpact: 'Notifications will not be delivered',
        notifyQueueNoConsumersAction: 'Ensure a server instance is running the notify consumer and Redis is configured',
        notifyQueuePendingHigh: 'Ops notify queue has {count} pending message(s)',
        notifyQueuePendingHighImpact: 'Consumer may be unhealthy or stuck',
        notifyQueuePendingHighAction: 'Check consumer heartbeat/logs and Redis stream group',
        notifyQueueLagHigh: 'Ops notify queue lag is high ({lag})',
        notifyQueueLagHighImpact: 'Notifications may be delayed',
        notifyQueueLagHighAction: 'Check notify consumer heartbeat, Redis load, and platform delivery latency',
      ...
      email: {
        ...
        platformLoadFailed: 'Failed to load notification platforms',
        ...
        validation: {
          ...
          alertPlatformRequired: 'Alert emails are enabled but no platform is selected',
          reportPlatformRequired: 'Report emails are enabled but no platform is selected',
          noPlatformsAvailable: 'No enabled platforms available. Configure and enable a platform in Notification settings first.',
    ...
    notifications: {
      ...
      description: 'Manage webhook notifications and events',
      platforms: 'Notification Platforms',
      addPlatform: 'Add Platform',
      editPlatform: 'Edit Platform',
      deletePlatform: 'Delete Platform',
      deleteConfirmMessage: 'Are you sure you want to delete this platform?',
      platformName: 'Platform Name',
      platformType: 'Platform Type',
      webhookUrl: 'Webhook URL',
      token: 'Token',
      secret: 'Secret',
      enableSign: 'Enable Signature',
      barkDeviceKeyHint: 'Bark Device Key',
      barkUrlHint: 'Optional: Custom Server URL',
      telegram: {
        botToken: 'Bot Token',
        chatId: 'Chat ID',
        apiBaseUrl: 'API Base URL',
        apiBaseUrlHint: 'Optional: Custom API Base URL',
        proxyUrl: 'Proxy URL',
        proxyUrlHint: 'Optional: Proxy URL'
      },
      smtp: {
        host: 'SMTP Host',
        port: 'SMTP Port',
        ...
        from: 'From Email',
        to: 'To Email',
        toHint: 'Recipient email address',
        secure: 'Use SSL/TLS',
      ...
      enableNotificationsHint: 'Master switch for all notifications',
      ...
      loadPlatformsError: 'Failed to load platforms',
      saveSuccess: 'Configuration saved successfully',
      saveError: 'Failed to save configuration',
      savePlatformSuccess: 'Platform saved successfully',
      savePlatformError: 'Failed to save platform',
      deleteSuccess: 'Platform deleted successfully',
      deleteError: 'Failed to delete platform',
      toggleSuccess: 'Platform status updated',
      toggleError: 'Failed to update platform status',
      testSuccess: 'Platform test successful',
      testError: 'Platform test failed',
      testSent: 'Test notification sent',
      testSendError: 'Failed to send test notification'
    }
  },
