  ...
  admin: {
    ...
    ops: {
      ...
      diagnosis: {
        ...
        notifyQueueStatusUnavailable: '通知队列状态不可用',
        notifyQueueStatusUnavailableImpact: '无法判断告警/报表通知是否正常投递',
        notifyQueueStatusUnavailableAction: '检查 Redis 连通性与 stream key 是否存在',
        notifyQueueDlqCritical: '通知 DLQ 中有 {count} 条消息',
        notifyQueueDlqCriticalImpact: '告警/报表通知可能未能送达',
        notifyQueueDlqCriticalAction: '查看 DLQ 条目原因，修复通知平台配置后再重试投递',
        notifyQueueNoConsumers: '通知队列没有活跃消费者',
        notifyQueueNoConsumersImpact: '通知将无法投递',
        notifyQueueNoConsumersAction: '确认有实例在运行 notify consumer 且 Redis 已配置',
        notifyQueuePendingHigh: '通知队列有 {count} 条 pending 消息',
        notifyQueuePendingHighImpact: '消费者可能卡住或处理缓慢',
        notifyQueuePendingHighAction: '检查消费者心跳/日志，以及 Redis stream group 状态',
        notifyQueueLagHigh: '通知队列积压较高（lag={lag}）',
        notifyQueueLagHighImpact: '通知可能延迟投递',
        notifyQueueLagHighAction: '检查 notify consumer 心跳、Redis 负载与平台发送耗时',
      ...
      email: {
        ...
        validation: {
          title: '请先修正以下问题',
          invalid: '邮件通知配置不合法',
          alertPlatformRequired: '已启用告警邮件，但未选择通知渠道',
          reportPlatformRequired: '已启用报告邮件，但未选择通知渠道',
          noPlatformsAvailable: '暂无可用通知渠道，请先在通知设置中添加并启用平台',
    ...
    notifications: {
      title: '通知设置',
      description: '管理 Webhook 通知和事件订阅',
      platforms: '通知平台',
      addPlatform: '添加平台',
      editPlatform: '编辑平台',
      deletePlatform: '删除平台',
      deleteConfirmMessage: '确定要删除此平台吗？',
      platformName: '平台名称',
      platformType: '平台类型',
      ...
      secret: '密钥',
      enableSign: '开启签名',
      barkDeviceKeyHint: 'Bark 设备 Key',
      barkUrlHint: '可选：自定义服务器地址',
      telegram: {
        botToken: 'Bot Token',
        chatId: 'Chat ID',
        apiBaseUrl: 'API 基础地址',
        apiBaseUrlHint: '可选：自定义 API 基础地址',
        proxyUrl: '代理地址',
        proxyUrlHint: '可选：代理服务器地址'
      },
      smtp: {
        host: 'SMTP 主机',
        port: 'SMTP 端口',
      ...
      enableNotificationsHint: '通知功能的总开关',
      retrySettings: '重试设置',
      maxRetries: '最大重试次数',
      retryDelay: '重试延迟 (秒)',
      timeout: '超时时间 (秒)',
      ...
      loadPlatformsError: '加载平台列表失败',
      saveSuccess: '配置保存成功',
      saveError: '保存配置失败',
      savePlatformSuccess: '平台保存成功',
      savePlatformError: '保存平台失败',
      deleteSuccess: '平台删除成功',
      deleteError: '删除平台失败',
      toggleSuccess: '平台状态已更新',
      toggleError: '更新平台状态失败',
      testSuccess: '平台测试成功',
      testError: '平台测试失败',
      testSent: '测试通知已发送',
      testSendError: '发送测试通知失败'
    }
  },
